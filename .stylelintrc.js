module.exports = {
    plugins: [
      'stylelint-order', // uses stylelint-order
    ],
    extends: [
      'stylelint-config-standard', // extends stylelint-config-standard, a standard shareable config for stylelint.
      // './node_modules/prettier-stylelint/config.js', // extends stylelint-config-prettier, i.e. turns off all rules unnecessary or incompartible with Prettier
    ],
    ignoreFiles: [
      '**/node_modules/**',
    ...
    rules: {
      ...
      'no-missing-end-of-source-newline': false, // 行末の改行を必須
    },
  };
