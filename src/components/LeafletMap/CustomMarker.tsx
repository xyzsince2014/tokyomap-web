...
const CustomMarker: React.FC<CustomMarkerProps> = ({tweet, timeRemaining}) => {
  ...
  return (
    ...
    <Marker position={[tweet.lat, tweet.lng]} icon={pin} key={`marker_${tweet.tweetId}`}>
